if(NOT TARGET Cinder-FMOD)
    ...
    file(GLOB SOURCE_LIST CONFIGURE_DEPENDS
            "${Cinder-FMOD_PROJECT_ROOT}/src/**/*.h"
            "${Cinder-FMOD_PROJECT_ROOT}/src/**/*.hpp"
            "${Cinder-FMOD_PROJECT_ROOT}/src/**/*.cc"
            "${Cinder-FMOD_PROJECT_ROOT}/src/**/*.cpp"
            "${Cinder-FMOD_PROJECT_ROOT}/src/**/*.c"
            "${Cinder-FMOD_PROJECT_ROOT}/src/*.h"
            "${Cinder-FMOD_PROJECT_ROOT}/src/*.hpp"
            "${Cinder-FMOD_PROJECT_ROOT}/src/*.cc"
            "${Cinder-FMOD_PROJECT_ROOT}/src/*.cpp"
